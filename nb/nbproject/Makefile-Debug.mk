...
${OBJECTDIR}/_ext/f133f6d3/Logger.o: ../cpluslogger/src/Logger.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f133f6d3/Logger.o ../cpluslogger/src/Logger.cpp

${OBJECTDIR}/_ext/f133f6d3/demo.o: ../cpluslogger/src/demo.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/f133f6d3
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f133f6d3/demo.o ../cpluslogger/src/demo.cpp
